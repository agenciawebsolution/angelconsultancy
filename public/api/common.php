    ...
    try {
        ...
        if ((int)$slidesCountStmt->fetchColumn() === 0) {
            $pdo->exec("INSERT IGNORE INTO `home_slides` 
                ...
                VALUES
                (1, 
                 'ANGEL CONSULTANCY AND NETWORK', 
                 'Assistência humana,', 
                 'simples e confiável', 
                 'para sua organização financeira e administrativa. Apoio humano, simples e confiável para você, sua organização financeira e administrativa. Orientação clara, acessível e verdadeira para tornar o seu mundo administrativo muito mais leve.', 
                 'Fale conosco', 
                 '#contato', 
